...
SAS is an Open OnDemand app that launches SAS as an interactive session on a
compute node. It is designed for researchers who need data management, advanced
analytics, multivariate analysis, business intelligence, and predictive
analytics.
...
SAS is an Open OnDemand Batch Connect app that launches SAS as an interactive
desktop session on HPC clusters. It is designed for researchers who need data
...
Edit `form.yml` and update these values for your cluster (in order as they
appear at the bottom of [form.yml](form.yml)):
...
| `custom_memory_per_node` | Memory per job (GB) | user-defined; default: `4` | Your preferred memory allocation |
...
your OOD dashboard and look for **SAS** under **Interactive Apps > Desktop
Apps**.
...
For bugs or feature requests, [open an issue](https://github.com/fasrc/ood-sas/issues).
...
- [SAS](https://www.sas.com/en_us/home.html) — the application launched by this OOD app.
- [Open OnDemand](https://openondemand.org/) — the HPC portal framework.

### Software Installation

- [SAS Linux installation
  guide](https://support.sas.com/en/documentation/install-center/94/guide-for-unix.html).
